...
Hub. After being "two months away" from launch for about 16 months, I can't even
...
If Jae was the crazy visionary, I was his first follower.
...
Meanwhile, the Cosmos community could not be stronger. Forget the price.
Everywhere I look I see amazing groups of people building amazing things, with
relentless passion and
inspiring compassion. The community we've grown together is an inspiration to
...
(ie. Tendermint Inc) has shown us what we already knew - governance matters, and
the CEO of a company needs to be held accountable, especially to the company's
employees.
But no matter. We're working hard on decentralizing functionality that used to
...
through a new subsidiary of the Interchain Foundation (ICF) in Berlin:
[Interchain
...
forward to continue working with all these entities as we shepherd the Cosmos
into the future.
...
summer, and officially spun out from the ICF in January. While I'm the CEO, the
...
Byzantine fault tolerant consensus protocols, and they're now full time working
...
world, and sets an example for how distributed systems software can and should be engineered.
...
and other transformative real world applications. For a bit more detail on each
of these, see the end of this post!

# Conclusion

The Cosmos Hub has been live for a year. It's hard to believe how far we've come
and how much we've accomplished and grown as a community, despite the various
set backs and stumbling blocks. We're stronger than we've ever been, and there's
...
for these platforms, and for Cosmos. I hope to see pegs to built to many other
...
the Ethereum
chain into their own blockchain, without losing the capacity to interoperate.
...
whole host of new capabilities to Cosmos and attract hoards of new developers by
...
virtual machines will unlock all kinds of new opportunities for decentralized
finance, governance, and general coordination and will become a cornerstone of
...
The Tendermint team, under the new GmbH, is taking stock of the entire codebase
and evaluating opportunities to improve the architecture and optimize protocols,
and with the help of the Informal team, make them more verifiable.
...
[2020
Roadmap](https://medium.com/tendermint/tendermint-2020-roadmap-b4709134cff1).
...
them in the wild with live economics, to allow them to prove themselves before
scaling their use even further. I hope to see that kind of experimentation begin
in earnest soon - there's no end to where it may go.

And then there's privacy. Right now Cosmos chains are a lot like early Ethereum
in
that there's virtual no privacy mechanisms. But with all the recent advancements
...
There's so many unique designs to explore here, and significant opportunity to
improve the privacy story of Cosmos, for financial applications, governance, and
more.

## Alternative Economics and Real World Applications

The whole reason I'm here is because the modern socioeconomic contract is broken
and we need to establish a new one. A new global economic order that
...
You can hear me rant about these things in talks about [Stakeholders and
...
technology. This is why I'm so excited about the Regen Network and the
