...
which was about to give way to the also copper-based Bronze Age),
gold and silver were much less useful. Perhaps they were already in
...
shares. It is seemingly not much of a stretch for a small volume weight of silver to stand in
for a similar weight of some much larger volume count of grain. Being more dense, the silver would
...
which can stand in for all other substances. But this is not the whole story.
As we will see, money is not just metaphor, but metonym.
...
Debts incurred might be settled directly on the books, using the
shekel as an accounting device, or they could be settled by a Medium of Exchange -
primarily, a count of grain, and to a lesser extent, weights of silver. 
...
for a millenium until the development of Hindo-Arabic numerals and Islamic
...
Clearing allow debts to be settled by balancing txs within and across balance sheets,
...
constitutes its own medium for the settling of payments. The line begins to blur
...
Again, the Medium of Exchange is needed in so far as there
...
units. Attention turned from balancing the payments graph to issuing enough
...
of the world's central banks and animosity over the exorbitant privilege (and curse!) afforded
to the United States, keeper of the global reserve.
The debate rages over what these reserves are and what they
...
network structure, on the need to balance the payments graph.

The 20th century, in Europe, especially, has seen growing recognition of the
...
multilateral ones that could be cleared. 
...
And later (TODO when?), when the US had become the world's largest debtor,
...
the matter. But more then this, we need to center the problem of balancing the
payments graph. At Informal Systems, 
we call this [Collaborative Finance (CoFi)](https://cofi.informal.systems) - a new science of liquidity savings and injection. 
