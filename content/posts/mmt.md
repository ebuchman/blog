...
its prioritation of real resource limits as the fundamental constraint on government spending, 
...
an economic advisor for Bernie Sanders, and AOCs subsequent championing of MMTs
...
by a notional promise to redeem currency for some "real money" (ie. metal, or USD that were themselves redeemable 
...
implies, and perhaps to lose it altogether (say, eg. when inflation ultimately forces you to borrow
...
without any regard for previous misallocations of resources. 
...
through the more insiduous route of inflation followed by taxation.
