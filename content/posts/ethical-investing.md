...
followed by Microsoft, and they top both ETFs. Vanguard then follows with
Amazon, Alphabet, Facebook, while iShares follows with Alphabet and Facebook,
but doesn't include Amazon at all.

It's hard to imagine companies more threatening to the social fabric of sustainable economic
societies than Google, Facebook, and Amazon. Google and Facebook are actively 
enabling, if not encouraging, psychological warfare that is devastating the mental 
health of younger generations and obliterating the foundations of democracy.
Facebook,  especially, is engaged in a perverse and insiduous evil, a form of
digital and psychological colonialism the moral reprehensibility of which may
not have been seen since the Dutch East India Company. And then there's Amazon,
slowly and steadily consuming the entire global supply chain, all but
...
probably far more environmentally sustainable than smaller companies. But the
business models themselves are fundamentally socially irresponsible. 
The idea that Google, Facebook, or Amazon could play any significant role in an ethically invested
portfolio seems abhorrent to me.
...
Modern financial institutions are engaged in a massive pyramid scheme that 
is propagating wage and debt slavery at unprecedented levels, 
mortgaging our collective future for a quick buck and inflating a
fundamentally unsustainable financial system. 
Yes, this is more true in the US than elsewhere, and Canadian banks have an
alleged soundness that is the envy of many nations. But no matter how many trees
...
was the most responsible thing to do. I tried and
failed to explain to him that I felt the same way about the banks as he might feel about
the tobacco companies, which he didn't like much, and so I couldn't buy them. 
...
We bonded over our respective account managers advising us to avoid both. 
My zaidy passed away this fall; I bought all 5 Canadian banks in his memory.
...
North America, ESG capital markets are surging. The European [ESG ETFs][iShares
Europe] are more
diversified across sectors like tech (ASML, SAP), industrial manufacturing (Siemens), 
health care (Roche, Novartis), and consumer goods (LVMH, Loreal, Nestle, Unilever). 
...
and others, like Loreal and Unilever, seem to be making credible
commitments to clean up their act (if you're okay with animal testing *TODO*
and sugar). It's promising, but these are all still massive companies,
and it seems no matter what, with multi-nationals, you're going to have to pick
your poison.

Then there's the Asian ESG ETFs, like the [iShares emerging markets one][iShares
Asia], which is almost 50% Chinese companies, dominated by giants Alibaba and
Tencent. I can't pretend to understand Chinese capitalism, but it seems like the large
companies are in general  arms of the Chinese government *TODO*, which is currently
...
a lot of weight to Korea (Samsung), Japan (Toyota, Sony), and Taiwan (Taiwan
Semiconductor Manufacturing). Korean and Japanese
companies are probably a lot more like European companies, but with less labour protections.
...
Africa's biggest public company, who also owns ~30% of Tencent.
...
which includes a variety of government bonds, plus a North American and a Developed Markets ETF. You can
probably imagine I'm not a fan of the way governments finance belligerent
spending through bonds, so I won't talk about them at all here. WealthSimple
released a great [summary of its approach][WealthSimple Summary]. Let's look at the [North
American ETF they use][WealthSimple ETF]. It contains all of FAAMG
(though only about ~0.4% of each). The biggest allocation (~5%) is to Hydro One,
...
and comprehensive analysis of socially responsible behaviour is an ethical minefield. 
...
include a number of Canadian entities like Desjardins (a co-operative of credit unions),
NEI (specializes in responsible investing), and
Waratah (alternative asset management firm that goes long and short based on its
own ESG ratings). Sometimes the holdings for particular funds can be harder
to find, so of course, do your own research, and if you discover other interesting issuers
and funds, please let me know - you can find me
...
Benefit Corporations were popularized by [B Labs][BLabs], an American non-profit 
that issues ["B Corp" certificates][BCorp] to corporations that uphold rigorous standards
of responsible corporate behaviour. B Labs offers its certificates
internationally, and there are currently over 3000 certified B Corps. However,
the vast majority of them are private companies. B Labs doesn't seem to publish
...
certifcation when it went public, which is quite a shame. *TODO*
...
love Twitter. Obviously it has a lot of issues around toxic cesspools and harassment, 
but it's also kind of magical.

A big part of the problem with socially responsible investment is the very restriction to
public securities. By the time a company goes public, almost by definition,
it has had to sacrifice quite substantially. The large public markets, underwritten by investment banks,
...
a variety of more socially responsible companies. 
Cryptocurrencies will continue to apply pressure here.
...
projects or other growth. Ontario has even relaxed securities laws specifically
...
In the end, this a pretty complex problem. And folks like Garadaras *TODO* levy amazing
